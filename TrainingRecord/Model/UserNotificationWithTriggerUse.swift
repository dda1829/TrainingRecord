...
class UserNotificationWithTriggerUse{
    static var share = UserNotificationWithTriggerUse()
    ...
    func setTimeTrigger(Timeinterval timeinterval: TimeInterval,isRepeated isrepeated: Bool){
        trigger = UNTimeIntervalNotificationTrigger(timeInterval: timeinterval, repeats: isrepeated)
    }
    func sendNotificationRequest(Identifier identifier:String, NotificationDate notificationdate: Date?, TriggerType type: String){
        var notificationRequest = UNNotificationRequest(identifier: "", content: content, trigger: nil)
        switch type {
        case "Calendar":
            notificationRequest = UNNotificationRequest(identifier: identifier, content: content, trigger: trigger as? UNCalendarNotificationTrigger)
        case "TimeInterval":
            notificationRequest = UNNotificationRequest(identifier: identifier, content: content, trigger: trigger as? UNTimeIntervalNotificationTrigger)
        default:
            print("wrong type")
            return
        }
